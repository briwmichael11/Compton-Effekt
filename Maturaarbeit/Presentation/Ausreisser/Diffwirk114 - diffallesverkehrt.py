...
datei_haupt = "114_diff.Wirkungsgrad_ohneTarget2 - Edit.Spe"      # Hauptdatei (wird gefittet)
datei_zusatz = "114_diff.Wirkungsgrad - Edit.Spe"    # Zweite Datei (nur Darstellung)
