...
startzeile = 14900  # erste Zeile = 1
endzeile = 15150  # letzte Zeile, inklusive
...
plt.bar(x, y, width=0.8, color='skyblue', edgecolor='blue', label='Messwerte (counts)')
plt.plot(x, ym, color='orange', linewidth=2, label='Gefittete Gaussfunktion')
plt.xlabel('Mark')
plt.ylabel('Counts')
